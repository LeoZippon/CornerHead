...
- [6. 元学习 Agent System Prompt（含默认 Fold 探索方向示例）](#prompt-section-6)
- [7. 元学习 Agent System Prompt（含默认 Fold 与当前 Meta 指令示例）](#prompt-section-7)
...
<details>
<summary>完整文本，15,573 字符</summary>
...
## 6. 元学习 Agent System Prompt（含默认 Fold 探索方向示例）

<details>
<summary>完整文本，17,381 字符</summary>
...
## 7. 元学习 Agent System Prompt（含默认 Fold 与当前 Meta 指令示例）
