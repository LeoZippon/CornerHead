...
def build_parser() -> argparse.ArgumentParser:
    ...
    build.add_argument("--fundamental-events-dir", type=Path, help="Optional PIT fundamental event directory to join into daily_alpha.")
    ...
    fundamental.add_argument("--dataset", action="append", choices=FUNDAMENTAL_EVENT_DATASETS, help="Dataset to include; repeatable. Defaults to all.")
    ...
    fundamental_audit.add_argument("--dataset", action="append", choices=FUNDAMENTAL_EVENT_DATASETS, help="Dataset to include; repeatable. Defaults to all.")
    fundamental_audit.add_argument("--output", type=Path, default=Path("results/data_quality/fundamental_events_status.json"))
    fundamental_audit.add_argument("--require-partitions", action="store_true", help="Fail the audit when no PIT event rows exist in the requested window.")
